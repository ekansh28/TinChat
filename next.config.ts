...
const nextConfig = {
  ...
  async headers() {
    ...
    const cspHeader = `
      ...
      img-src 'self' data: blob: ${cdn} https://placehold.co https://github.com https://storage.googleapis.com https://www.paypal.com https://*.paypal.com https://www.paypalobjects.com https://*.paypalobjects.com https://unpkg.com https://cdn.jsdelivr.net ${supabaseHostname} https://s3-us-east-2.amazonaws.com;
