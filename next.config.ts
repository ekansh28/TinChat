...
const nextConfig = {
  ...
  async headers() {
    ...
    const cspHeader = `
      ...
      media-src 'self' blob: *;
      connect-src 'self' ${cdn} ${socketServerUrl} ${socketWsUrl} ${socketWssUrl} 
        ws://localhost:3000 ws://127.0.0.1:3000 ws://localhost:3001 ws://127.0.0.1:3001 
        wss://localhost:3001 wss://127.0.0.1:3001 wss://${supabaseHostname} 
        https://${supabaseHostname} https://unpkg.com https://s3-us-east-2.amazonaws.com 
